  ...
  try {
    ...
    const contents = uncleanedMedicineData.RegisteringMedicinePurposeData.map((obj) => {
      ...
      const purposeOfPrescription = obj.UsedMedicineForDiagnosis ? obj.UsedMedicineForDiagnosis.nameKr
                                      : obj.UsedMedicineForSymptom ? obj.UsedMedicineForSymptom.nameKr : '-';
      const perceivedEffect = !obj.perceivedEffectiveness ? '-'
      ...
      const degreeOfSideEffect = !obj.RegisteredMedicinePurposeData.RegisteredMedicineEvaluationData.sideEffects ? '-'
      ...
      const symptomOfSideEffect = obj.RegisteredMedicinePurposeData.RegisteredMedicineSideEffectsData ? obj.RegisteredMedicinePurposeData.RegisteredMedicineSideEffectsData[0].SymptomOfSideEffects.nameKr + ' 등' : '-';
