  ...
  render() {
    return (
      <div>
        ...
        <p className={cx('text')}>아프다 스페이스는 이용자 식별을 위해 카카오톡 측에서 제공하는 고유식별 ID만을 활용합니다. 카카오톡에서 [필수] 항목으로 지정한 '프로필 정보(닉네임/프로필 사진)'은 아프다 스페이스 내에서 어떠한 형식으로든 활용되거나 보여지지 않음을 밝힙니다.</p>
      </div>
    );
  }
}
