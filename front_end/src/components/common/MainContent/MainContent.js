  ...
  <div className={cx('main-content-notice')}>
    ...
    <p className={cx('main-content-text')}>아프다 스페이스에서는 다음과 같은 일들을 할 수 있습니다.
      <ul>
        ...
        <li> 자신이 겪은 진단명과 처방약, 증상에 대한 데이터를 제출할 수 있습니다. 작성된 데이터들이 모여 앞으로 비슷한 어려움을 겪게 될 사람들에게 유익한 정보로 가공됩니다.</li><br/>
        <li> 정신 건강에 관련된 다양한 주제들에 대해 논의할 수 있습니다.</li>
      </ul>
    </p>
    <br/>
    <p className={cx('main-content-text')}> 아프다 스페이스는 사용자의 소중한 건강 데이터를 다루고 있는 만큼, 서비스를 투명하게 운영하기 위해 노력하고 있습니다. <span role="img" aria-label="">&#128273;</span><a className={cx('link')} href="https://www.notion.so/a4f73730121a41658a261b5670fcc3f0">사용자의 개인 정보를 어떻게 다루는지</a>에 대한 부분을 포함하여, 서비스 운영과 관련하여 최대한 많은 부분을 점차 공유해나갈 예정입니다.</p>
