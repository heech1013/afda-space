...
const MainContent = () => (
  <div className={cx('main-content-notice')}>
    ...
    <br/>
    <p className={cx('main-content-text')}>아프다 스페이스에서는 다음과 같은 일들을 할 수 있습니다.
      <ul>
        <li> 자신과 같은 진단명, 예를 들면 우울장애를 겪고 있는 사람들이 <span className={cx('bold')}>어떤 처방약을 먹고, 어떤 증상을 주로 겪었는지</span> 살펴볼 수 있습니다.</li><br/>
        <li> 자신과 같은 처방약, 예를 들면 렉사프로정을 먹고 있는 사람들은 <span className={cx('bold')}>어떤 목적으로 이 약을 처방 받았고, 어떤 효과를 보았고, 어떤 부작용을 겪었는지</span> 살펴볼 수 있습니다.</li><br/>
        <li> 자신이 겪은 진단명과 처방약, 증상에 대한 데이터를 프로필에 추가하여 아프다 스페이스의 <span className={cx('bold')}>정보 생태계에 기여할 수 있습니다.</span> 추가된 데이터들은 통계화되어 앞으로 비슷한 어려움을 겪게 될 사람들에게 유익한 정보를 제공합니다.</li><br/>
